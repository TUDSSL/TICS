...
;; iikoe
(define_insn "morestack_call"
  [(unspec_volatile [(const_int 0)] UNS_MORESTACK_CALL)]
  "msp430x"
  "CALLA #__morestack2"
  )

(define_insn "morestack_check"
...
(define_insn "morestack_check_small"
  [(unspec_volatile [(match_operand 0 "immediate_operand" "i")
		     (match_operand 1 "immediate_operand" "i")
             ] UNS_MORESTACK_CHECK_SMALL)]
  "msp430x"
