...
static void SenseC$SenseTemp$readDone(error_t result, SenseC$SenseTemp$val_t val);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SenseC$Boot$booted(void );
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void SenseC$SenseMoist$readDone(error_t result, SenseC$SenseMoist$val_t val);
# 3 "Send.nc"
static void SenseC$Send$sendDone(error_t result);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SenseC$sendTask$runTask(void );
#line 75
static void SenseC$senseTempTask$runTask(void );
#line 75
static void SenseC$senseMoistTask$runTask(void );
...
static void PlatformLedsC$Led0$set(void );
static void PlatformLedsC$Led0$clr(void );
#line 40
static void PlatformLedsC$Led1$set(void );
static void PlatformLedsC$Led1$clr(void );
#line 40
static void PlatformLedsC$Led2$set(void );
static void PlatformLedsC$Led2$clr(void );
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static error_t /*SenseAppC.SensorMoist*/DemoSensorC$0$Read$read(void );
#line 55
static error_t /*SenseAppC.SensorTemp*/DemoSensorC$1$Read$read(void );
# 2 "Send.nc"
static error_t SendC$Send$send(void );
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static error_t SenseC$SenseTemp$read(void );
#line 55
static error_t SenseC$SenseMoist$read(void );
# 2 "Send.nc"
static error_t SenseC$Send$send(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SenseC$sendTask$postTask(void );
#line 67
static error_t SenseC$senseTempTask$postTask(void );
# 61 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SenseC$senseMoistTask$postTask(void );
# 59 "SenseC.nc"
