...
#define SEED 4L
//#define ITER 100
NVM volatile int ITER = 100;
NVM volatile int FUNC_ITER = 7;
#define CHAR_BIT 8
...
NVM volatile unsigned int n_0=0, n_1=0, n_2=0, n_3=0, n_4=0, n_5=0, n_6=0;
int application_main(void)
{
    //	while(true){
    uint32_t seed;
    unsigned iter;
    volatile unsigned func;
    ...
    for (func = 0; func < FUNC_ITER; func++) {
        TASK_CHECKPOINT();
